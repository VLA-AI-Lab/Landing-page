...
export default function ResearchPage() {
  return (
    <>
      {/* ────────────────────── HERO ────────────────────── */}
      <section className="relative bg-[#1B1340] py-20 lg:py-28 overflow-hidden">
        <div className="absolute inset-0 hero-pattern opacity-20" />
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[#1B1340]/60 to-[#1B1340]" />
      ...
      <section className="py-20 lg:py-28 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-[#1D9E75] font-bold uppercase tracking-widest text-sm mb-2 block">
              Focus Areas
            </span>
          ...
          {domains.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {domains.map((d) => (
                <div
                  key={d.title}
                  className="bg-white p-8 rounded-xl border border-slate-200 hover:border-[#7F77DD]/30 hover:shadow-md transition-all duration-200 group"
                >
                  <div className="w-14 h-14 bg-[#7F77DD]/10 rounded-xl flex items-center justify-center mb-6 text-[#7F77DD] group-hover:bg-[#7F77DD] group-hover:text-white transition-colors duration-200">
                    <d.icon className="size-7" strokeWidth={1.5} />
                  </div>
                  <span className="text-xs font-semibold text-[#1D9E75] uppercase tracking-wider">
                    {d.tagline}
                  </span>
      ...
      <section className="py-20 lg:py-28 bg-white border-y border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-[#EF9F27] font-bold uppercase tracking-widest text-sm mb-2 block">
              Our Work
            </span>
            <h2 className="text-3xl lg:text-4xl font-display font-bold text-slate-900">
              Featured Projects
              ...
              {projects.map((proj) => (
                ...
                >
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    <h3 className="text-xl font-bold text-slate-900 mb-3 group-hover:text-[#7F77DD] transition-colors">
                      {proj.title}
                    </h3>
                    <p className="text-slate-600 leading-relaxed mb-5 flex-1">
                      {proj.description}
                    </p>
                    <div className="flex items-center gap-1 text-[#7F77DD] font-medium text-sm">
                    ...
                    <span
                      ...
                      className={`px-4 py-1.5 rounded-full text-sm font-medium cursor-pointer transition-colors ${
                        i === 0
                          ...
                          : 'bg-white text-slate-600 border border-slate-200 hover:border-[#7F77DD]/30'
                      }`}
                    >
                      {tab}
                    </span>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                      <div className="flex-1">
                        <div className="flex flex-wrap items-center gap-2 mb-2">
                          <span className="text-xs font-bold text-[#7F77DD] bg-[#7F77DD]/10 px-2.5 py-0.5 rounded-full uppercase tracking-wide">
                            {pub.venue}
                          </span>
                          {pub.featured && (
                            <span className="text-[10px] font-bold uppercase tracking-wider text-[#EF9F27] bg-[#EF9F27]/10 px-2 py-0.5 rounded-full">
                              Featured
                            </span>
                          )}
      ...
      {/* ────────────────────── METHODOLOGY ────────────────────── */}
      <section className="py-20 lg:py-28 bg-[#1B1340] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {[
                ...
                <div key={m.step} className="relative text-center">
                  <div className="w-16 h-16 mx-auto bg-white text-[#1B1340] rounded-full flex items-center justify-center font-bold text-xl shadow-lg mb-6 relative z-10 border-4 border-white/20">
                    {m.step}
                  </div>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="/partners"
              className="bg-[#7F77DD] text-white hover:bg-[#6860C7] px-8 py-3.5 rounded-lg font-semibold text-lg transition-colors shadow-md inline-flex items-center gap-2"
            >
